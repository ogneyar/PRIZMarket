...
Function _info_otvetnoe() {
	...
	$reply = "⭕️Ежели Ваше объявление требует повтора, достаточно [скопировать ссылку](https://t.me/podrobno_s_PZP/573) на Ваш пост и отправить в этот бот с просьбой повторить.⭕️
