...
function _info() {
	...
	$reply = "Здравия всем!
❗️ДОБРО ПОЖАЛОВАТЬ на канал,  в котором предлагаются товары или услуги, как для продажи, так и для покупки. Предложения рассматриваются через бот👉https://t.me/Zakaz_prizm_bot
 
Что нужно для того чтобы заявка была принята?

▪️Зайти в бот Zakazprizmbot(https://t.me/Zakaz_prizm_bot) и нажать 
/start

- далее необходимо отправить 2⃣(2)два сообщения:
