...
function _ввод_местонахождения() {
	...
	$reply = "|\n|\n|\n|\n|\nВведите хештеги местонахождения: (не больше трёх)\n\nВНИМАНИЕ: вводите хештеги без пробелов(!), (#Весь мир 👈🏻 это будет ошибка) можно использовать вместо пробела подчёркивание _. Никакие другие символы вводить нельзя. В случае неверного ввода администрация может по этой причине отклонить заявку и её тогда придётся создавать заново.\n\nПример:\n#Весь_мир #Россия #Ростов_на_Дону";
