...
$mail->Body    = "&nbsp;&nbsp;Здравствуйте <b>{$логин}</b>, это письмо отправлено Вам для продолжения регистрации на сайте <span>PRIZMarket</span>.<br><br>&nbsp;&nbsp;На это письмо отвечать не нужно.<br>Просто перейдите по ссылке ниже.<br><br>&nbsp;&nbsp;<a href='https://pokamojettak.sru'>https://pokamojettak.sru</a>";
...
if(!$mail->send()) {	
    ...
    echo "<h3>Сообщение отправлено!</h3><br><br>Проверьте почту, перейдите по присланной Вам ссылке для окончания регистрации. Если письмо не пришло проверьте папку СПАМ.<br><br>После окончания регистрации зайдите в личный кабинет.";
