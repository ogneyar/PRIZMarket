...
$mail->From = 'prizmarket@fignet.ru';
...
$mail->Body    = "&nbsp;&nbsp;Здравствуйте <b>{$логин}</b>, это письмо отправлено Вам для продолжения регистрации на сайте <span>PRIZMarket</span>.<br><br>&nbsp;&nbsp;На это письмо отвечать не нужно. Просто перейдите по ссылке ниже.<br><br>&nbsp;&nbsp;<a href='{$ссылка_подтверждения}'>{$ссылка_подтверждения}</a>";
