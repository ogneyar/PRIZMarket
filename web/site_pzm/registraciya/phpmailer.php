...
$mail->Body    = "&nbsp;Здравствуйте <b>{$логин}</b>, это письмо отправлено Вам для продолжения регистрации на сайте <span>PRIZMarket</span>.<br><br>&nbsp;На это письмо отвечать не нужно.<br>Просто перейдите по ссылке ниже.<br><br>&nbsp;https://pokamojettak.sru";
