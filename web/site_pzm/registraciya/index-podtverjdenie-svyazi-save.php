...
$запрос = "UPDATE `site_users` SET podtverjdenie='true', svyazi='{$связь}', svyazi_data='{$данные_связи}' WHERE login='{$логин}'"; 
...
$body = "&nbsp;&nbsp;Здравствуйте <b>{$логин}</b>, Регистрация успешно завершена. Ваши данные, для связи клиентов с Вами добавлены!<br><br>&nbsp;&nbsp;Это информационное письмо, на него не нужно отвечать.";
